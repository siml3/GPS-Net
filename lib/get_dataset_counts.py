...
from lib.pytorch_misc import nonintersecting_2d_inds, intersect_2d


def get_counts_new(train_data=VG(mode='train', filter_duplicate_rels=False, num_val_im=5000), must_overlap=True):
    """
