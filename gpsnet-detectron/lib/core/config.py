...
__C.TRAIN.RELS_PER_IMG_REFINE = 64
...
# NMS threshold used on RPN proposals (used during end-to-end training with RPN)
__C.TRAIN.PRUNE_PAIRS_NMS_THRESH = 0.7

# Number of top scoring RPN proposals to keep before applying NMS (per image)
# When FPN is used, this is *per FPN level* (not total)
__C.TRAIN.PRUNE_PAIRS_PRE_NMS_TOP_N = 6000

# Number of top scoring RPN proposals to keep after applying NMS (per image)
# This is the total number of RPN proposals produced (for both FPN and non-FPN
# cases)
__C.TRAIN.PRUNE_PAIRS_POST_NMS_TOP_N = 1000

__C.TRAIN.PRUNE_PAIRS_FG_FRACTION = 0.5
# Total number of examples
__C.TRAIN.PRUNE_PAIRS_BATCHSIZE = 256

__C.TRAIN.PRUNE_PAIRS_NEGATIVE_OVERLAP = 0.15
__C.TRAIN.PRUNE_PAIRS_POSTIVE_OVERLAP = 0.25
...
## NMS threshold used on RPN proposals
__C.TEST.PRUNE_PAIRS_NMS_THRESH = 0.7

# Number of top scoring RPN proposals to keep before applying NMS
# When FPN is used, this is *per FPN level* (not total)
__C.TEST.PRUNE_PAIRS_PRE_NMS_TOP_N = 6000

# Number of top scoring RPN proposals to keep after applying NMS
# This is the total number of RPN proposals produced (for both FPN and non-FPN
# cases)
__C.TEST.PRUNE_PAIRS_POST_NMS_TOP_N = 1000
# Proposal height and width both need to be greater than RPN_MIN_SIZE
# (at orig image scale; not scale used during training or inference)
...
__C.MODEL.BG_VS_FG = 0.1
__C.MODEL.OBJS_LOSS_FACTOR = 1.0
__C.MODEL.PRDS_LOSS_FACTOR = 0.25
...
__C.FAST_RCNN.ROI_BOX_HEAD_PRD = ''
...
__C.LANGUAGE = AttrDict()
# Word embedding directory
__C.LANGUAGE.WORD_VECS = 'word_embed'

__C.LANGUAGE.OBJS_CLASSES = []
